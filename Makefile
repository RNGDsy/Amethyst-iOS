...
jre: native
	...
	$(call METHOD_JAVA_UNPACK,25,'https://github.com/Taylen-chud/angelauramc-openjdk-build/releases/download/Jre25.03-iOS/jre25-ios-arm64-20260708-release.tar.xz'); \
	cd $(SOURCEDIR); \
